function psql_add_db --description "creates new DB on existing instance with new user"
	argparse --name='psql_add_db' 'help' "h/host=" "p/port=" "U/username=" "W/password=" "u/existing-user=" -- $argv
	or return
