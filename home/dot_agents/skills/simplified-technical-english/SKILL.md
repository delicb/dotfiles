...
with one clear meaning. Use technical terms established by the current project.
For full dictionary compliance, consult the official standard:
...
- Proper nouns and product names (`GitHub`, `PostgreSQL`, or the current product name)
...
2. Keep **one technical noun per concept**. Use the terms established by the
   current project. Do not invent synonyms. Preserve product names and capitalization.
...
Use the terms established by the current project.

- Check existing UI text, documentation, code, and product glossaries.
- Use one term for each concept.
- Do not replace established terms with synonyms.
- Preserve product names and capitalization.
- Keep internal code names out of user-facing text.
- If the project defines writing rules, those rules take priority.
...
- [ ] One term per concept; project vocabulary is consistent
